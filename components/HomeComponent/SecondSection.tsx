...
export default function SecondSection() {
    return (
        <div className=' w-full flex flex-col py-14 relative z-10  bg-[#000000] items-center px-6 lg:px-12' >
            <p className=' font-Poppins-Bold text-2xl lg:text-5xl text-center text-[#00D1FF] ' >Supercharging communities</p>
            <p className=' font-Poppins-SemiBold text-[#99EDFF] mt-8 max-w-[550px] text-center ' >Oddstacker is a players vs players sports gaming system where
